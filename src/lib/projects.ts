...
export const projects: readonly Project[] = [
  {
    ...
    title: "FIDA Delivery",
    subtitle:
      "Bishoftu's first on-demand delivery network. Two React Native apps and a shared design system, shipped by one designer/engineer.",
    year: "2025 — present",
    role: "Co-founder · design + engineering",
    stack: ["Expo SDK 56", "React Native", "MapLibre", "Firebase", "EAS"],
    metric: "12+ partners · 500+ deliveries",
    status: "case-study",
    span: "wide",
    accent: "blue",
    image: "fida-delivery",
